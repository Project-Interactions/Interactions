...
//nco remove
mods.enderio.AlloySmelter.remove(item('nuclearcraft:alloy:10'))
mods.enderio.AlloySmelter.remove(item('nuclearcraft:alloy:2')*2)
mods.enderio.AlloySmelter.remove(item('nuclearcraft:alloy:11')*2)
//add
...
mods.enderio.AlloySmelter.recipeBuilder()
        ...
        .register()
mods.enderio.AlloySmelter.recipeBuilder()
        .input(item('enderio:item_material:36'), item('industrialforegoing:pink_slime_ingot'), item('industrialforegoing:pink_slime'))
...
mods.enderio.AlloySmelter.recipeBuilder()
        ...
        .register()
mods.enderio.AlloySmelter.recipeBuilder()
        .input(item('botania:manaresource:14'), item('threng:material'),item('nuclearcraft:alloy:10'))

...
recipes.addShaped(<enderstorage:ender_storage:1>, [[<botania:blazeblock>, <botania:spreader:2>, <botania:blazeblock>],[<tconstruct:large_plate>.withTag({Material: "obsidian"}), <tinkertoolcasts:tank_reinforced>, <tconstruct:large_plate>.withTag({Material: "obsidian"})], [<botania:blazeblock>, <wirelessutils:fluxed_pearl>, <botania:blazeblock>]]);

...
recipes.addShaped(<enderstorage:ender_storage:1>, [[<botania:blazeblock>, <botanicadds:mana_tesseract>, <botania:blazeblock>],[<tconstruct:large_plate>.withTag({Material: "obsidian"}), <tinkertoolcasts:tank_reinforced>, <tconstruct:large_plate>.withTag({Material: "obsidian"})], [<botania:blazeblock>, <wirelessutils:fluxed_pearl>, <botania:blazeblock>]]);

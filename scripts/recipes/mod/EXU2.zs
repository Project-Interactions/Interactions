...
recipes.addShaped(<extrautils2:passivegenerator> * 2, [[null, <solarflux:solar_panel_2>, null],[<jaopca:item_gearaquamarine>, <solarflux:solar_panel_2>, <jaopca:item_gearaquamarine>], [<extrautils2:decorativesolid:2>, <extrautils2:ingredients>, <extrautils2:decorativesolid:2>]]);
...
recipes.addShaped(<extrautils2:resonator>, [[<tconstruct:seared>, <tconstruct:seared>, <tconstruct:seared>],[<extrautils2:ingredients>, <extrautils2:machine>, <extrautils2:ingredients>], [<astralsorcery:itemcraftingcomponent:4>, <contenttweaker:useful_block>, <astralsorcery:itemcraftingcomponent:4>]]);
...
recipes.addShaped(<extrautils2:machine> * 2, [[<ore:plateBrass>, <contenttweaker:sub_block_holder_0:5>, <thaumcraft:plate:2>],[<immersiveintelligence:metal_decoration:2>, <ore:dustPlatinum>, <immersiveintelligence:metal_decoration:2>], [<thaumcraft:plate:2>, <contenttweaker:sub_block_holder_0:5>, <ore:plateBrass>]]);

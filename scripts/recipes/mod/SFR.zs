...
recipes.addShaped(<solarflux:solar_panel_2> * 2, [[<solarflux:mirror>, <solarflux:mirror>, <solarflux:mirror>],[<solarflux:solar_panel_1>, <ore:craftingPiston>, <solarflux:solar_panel_1>], [<solarflux:solar_panel_1>, <minecraft:piston>, <solarflux:solar_panel_1>]]);
recipes.addShaped(<solarflux:solar_panel_1> * 2, [[<solarflux:mirror>, <solarflux:mirror>, <solarflux:mirror>],[<minecraft:stonebrick>, <ore:ingotRefinedIron>, <minecraft:stonebrick>], [<minecraft:stonebrick>, <minecraft:stonebrick>, <minecraft:stonebrick>]]);
recipes.addShaped(<solarflux:solar_panel_8>, [[<solarflux:photovoltaic_cell_6>, <solarflux:photovoltaic_cell_6>, <solarflux:photovoltaic_cell_6>],[<moreplates:draconium_gear>, <tconstruct:large_plate>.withTag({Material: "dark_matter"}).onlyWithTag({Material: "dark_matter"}), <moreplates:draconium_gear>], [<solarflux:solar_panel_7>, <mysticalagradditions:special:1>, <solarflux:solar_panel_7>]]);
recipes.addShaped(<solarflux:solar_panel_7>, [[<solarflux:photovoltaic_cell_5>, <solarflux:photovoltaic_cell_5>, <solarflux:photovoltaic_cell_5>],[<actuallyadditions:block_crystal_empowered:4>, <taiga:nucleum_ingot>, <actuallyadditions:block_crystal_empowered:4>], [<solarflux:solar_panel_6>, <ore:ingotYellorium>, <solarflux:solar_panel_6>]]);
...
recipes.addShaped(<solarflux:solar_panel_5>, [[<solarflux:photovoltaic_cell_3>, <solarflux:photovoltaic_cell_3>, <solarflux:photovoltaic_cell_3>],[<embers:plate_caminite>, <jaopca:item_plateastralstarmetal>, <embers:plate_caminite>], [<solarflux:solar_panel_4>, <ore:blockPlatinum>, <solarflux:solar_panel_4>]]);
...
recipes.addShaped(<solarflux:photovoltaic_cell_6> * 2, [[<techreborn:ingot:17>, <techreborn:ingot:17>, <techreborn:ingot:17>],[<moreplates:osmium_gear>, <moreplates:osmium_gear>, <moreplates:osmium_gear>], [<solarflux:photovoltaic_cell_5>, <solarflux:photovoltaic_cell_5>, <solarflux:photovoltaic_cell_5>]]);
...
recipes.addShaped(<solarflux:photovoltaic_cell_3> * 2, [[<enderio:block_holier_fog>, <enderio:block_holier_fog>, <enderio:block_holier_fog>],[<botania:elfglass>, <botania:elfglass>, <botania:elfglass>], [<solarflux:photovoltaic_cell_2>, <solarflux:photovoltaic_cell_2>, <solarflux:photovoltaic_cell_2>]]);
...
recipes.addShaped(<solarflux:mirror> * 2, [[<ore:glassReinforced>, <ore:glassReinforced>, <ore:glassReinforced>],[null, <ore:plateIron>, null], [null, null, null]]);

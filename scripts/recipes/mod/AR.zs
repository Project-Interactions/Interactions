...
Assembler.addRecipe(<ore:circuitMaster>*2,<ore:ingotPsiMetal>,<ore:plateSiliconCarbide>*2,<libvulpes:structuremachine>,<contenttweaker:blank_ar_chip>);
...
Assembler.addRecipe(<contenttweaker:blank_ar_chip>,<ore:gearBloodBronze>*2,<ore:plateAlchemicalBrass>*4,null,<advancedrocketry:ic:3>);

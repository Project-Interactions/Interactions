...
<ore:LivingMatter>.add(<deepmoblearning:living_matter_extraterrestrial>);
<ore:LivingMatter>.add(<deepmoblearning:living_matter_twilight>);

<ore:slimeball>.remove(<aether_legacy:swetty_ball>);
<ore:slimeball>.remove(<tconstruct:edible:1>);
<ore:slimeball>.remove(<tconstruct:edible:2>);

...
recipes.addShaped(<industrialforegoing:laser_base>, [[<industrialforegoing:plastic>, <moreplates:pig_iron_gear>, <industrialforegoing:plastic>],[<moreplates:mirion_gear>, <moreplates:pig_iron_gear>, <moreplates:mirion_gear>], [<moreplates:terrasteel_gear>, <teslacorelib:machine_case>, <moreplates:terrasteel_gear>]]);
recipes.addShaped(<industrialforegoing:laser_drill>, [[<industrialforegoing:plastic>, <industrialforegoing:laser_lens>, <industrialforegoing:plastic>],[<industrialforegoing:plastic>, <ore:blockUranium>, <industrialforegoing:plastic>], [<moreplates:mirion_gear>, <teslacorelib:machine_case>, <moreplates:mirion_gear>]]);
...
recipes.removeShaped(<industrialforegoing:laser_base>, [[<industrialforegoing:plastic>, <minecraft:glowstone>, <industrialforegoing:plastic>], [<ore:gearGold>, <minecraft:glowstone>, <ore:gearGold>], [<ore:gearDiamond>, <teslacorelib:machine_case>, <ore:gearDiamond>]]);
recipes.removeShaped(<industrialforegoing:laser_drill>, [[<industrialforegoing:plastic>, <industrialforegoing:laser_lens>, <industrialforegoing:plastic>], [<ore:blockGlassColorless>, <minecraft:glowstone>, <ore:blockGlassColorless>], [<ore:gearDiamond>, <teslacorelib:machine_case>, <ore:gearDiamond>]]);
recipes.removeShaped(<industrialforegoing:laser_lens>, [[null, <industrialforegoing:pink_slime>, null], [<industrialforegoing:pink_slime>, <minecraft:stained_glass_pane>, <industrialforegoing:pink_slime>], [null, <industrialforegoing:pink_slime>, null]]);

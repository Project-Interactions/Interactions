...
recipes.addShaped(<solarflux:photovoltaic_cell_3> * 2, [[<enderio:block_holier_fog>, <enderio:block_holier_fog>, <enderio:block_holier_fog>],[<thaumicaugmentation:fortified_glass>, <thaumicaugmentation:fortified_glass>, <thaumicaugmentation:fortified_glass>], [<solarflux:photovoltaic_cell_2>, <solarflux:photovoltaic_cell_2>, <solarflux:photovoltaic_cell_2>]]);

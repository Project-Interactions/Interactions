...
RecipeUtils.recipeTweak(true, <nuclearcraft:pressurizer>, [[<ore:circuitThaumic>, <ore:blockTough>, <ore:circuitThaumic>], [<ore:gearAdvancedElectronicAlloy>, <ore:emptyFrame>, <ore:gearAdvancedElectronicAlloy>], [<ore:circuitThaumic>, <ore:blockTough>, <ore:circuitThaumic>]]);
...
RecipeUtils.recipeTweak(true, <nuclearcraft:assembler>, [[<ore:circuitOperation>, <ore:gearHardCarbon>, <ore:circuitOperation>], [<ore:plateFerroboron>, <ore:emptyFrame>, <ore:plateFerroboron>], [<ore:circuitOperation>, <ore:plateFerroboron>, <ore:circuitOperation>]]);

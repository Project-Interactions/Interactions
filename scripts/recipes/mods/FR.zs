...
mods.forestry.Carpenter.addRecipe(<forestry:flexible_casing>, [[<actuallyadditions:item_crystal_empowered:4>, <soot:ingot_antimony>, <actuallyadditions:item_crystal_empowered:4>], [<soot:ingot_antimony>, <forestry:sturdy_machine>, <soot:ingot_antimony>], [<actuallyadditions:item_crystal_empowered:4>, <soot:ingot_antimony>, <actuallyadditions:item_crystal_empowered:4>]], 60, <liquid:distwater> * 2000);

...
RuneAltar.removeRecipe(<botaniverse:morerune:1> * 2);
RuneAltar.removeRecipe(<botaniverse:morerune:2> * 2);
RuneAltar.removeRecipe(<botaniverse:morerune:3> * 2);
RuneAltar.addRecipe(<botaniverse:morerune>, [<ore:runeWrathB>, <ore:runeWaterB>, <ore:runeWinterB>, <ore:ingotElvenElementium>], 200000);
RuneAltar.addRecipe(<botaniverse:morerune:1>, [<ore:runeWrathB>, <ore:runeAutumnB>, <ore:runeFireB>, <ore:ingotTerrasteel>], 1000000);
RuneAltar.addRecipe(<botaniverse:morerune:2>, [<ore:runeLustB>, <ore:runeSummerB>, <ore:runeAirB>, <ore:ingotGaia>], 5000000);
RuneAltar.addRecipe(<botaniverse:morerune:3>, [<ore:runePrideB>, <ore:runeAirB>, <ore:runeAutumnB>, <ore:ingotGaiasteel>], 25000000);
//orechid rework

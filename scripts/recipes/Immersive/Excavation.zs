...
TweakedExcavator.addMineralWithCustomYield("Aether",10, 0.05, ["oreAmbrosium", "oreZanite", "oreGravitite","icestone"], [0.01,0.005, 0.002,0.02],powerTier1,4000,[1],[13]);

TweakedExcavator.addMineralWithCustomYield("Nether",10, 0.05, ["oreCobalt", "oreArdite", "minecraft:quartz_ore"], [0.01,0.01,0.05],powerTier1,4000,[1],[-1]);

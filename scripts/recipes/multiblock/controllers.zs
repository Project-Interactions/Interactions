...
recipes.addShaped(<modularmachinery:psi_converter_controller>, [[<psi:psi_decorative:8>, <psicosts:material_glassy>, <psi:psi_decorative:7>],[<psicosts:material_glassy>, <psicaster:caster>, <psicosts:material_glassy>], [<psi:psi_decorative:7>, <psicosts:material_glassy>, <psi:psi_decorative:8>]]);
recipes.addShaped(<modularmachinery:lightning_infuser_controller>, [[<ore:blockMystic>, <lightningcraft:lightning_cell:2>, <ore:blockMystic>],[<lightningcraft:lightning_cell:2>, <lightningcraft:lightning_infuser>, <lightningcraft:lightning_cell:2>], [<ore:blockMystic>, <lightningcraft:lightning_cell:2>, <ore:blockMystic>]]);
recipes.addShaped(<modularmachinery:part_stamper_controller>, [[<ore:scaffoldingSteel>, <minecraft:anvil>, <ore:scaffoldingSteel>],[<ore:scaffoldingSteel>, null, <ore:scaffoldingSteel>], [<ore:scaffoldingSteel>, <tconstruct:tooltables:2>, <ore:scaffoldingSteel>]]);
//builder

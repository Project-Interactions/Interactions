...
val cr as RecipeMap = <mbd:recipe_map:chemical_reactor>;

cr.start()
    .duration(100)
    .inputItems(<ore:dustCalcium>*3,<contenttwekaer:precipitate_platinum_dust>)
...
cr.start()
    ...
    .outputItems(<contenttwekaer:precipitate_platinum_dust>*2,<contenttweaker:platinum_salt_dust>)
    .inputFE(10000)
    .buildAndRegister();
...
cr.start()
    ...
    .inputItems(<contenttwekaer:dusty_platinum>)

...
advancedalloy.representativeItem = <item:techreborn:ingot:20>;
advancedalloy.liquid = <liquid:advancedalloy>;
advancedalloy.addItem(<ore:ingotAdvancedAlloy>);
advancedalloy.localizedName = "高级合金";
...
advancedalloy.addCoreMaterialStats(18,16.5);
...
crystalline_pink_slime.localizedName = "晶化粉红史莱姆";
...
crystalline_pink_slime.addCoreMaterialStats(10,25);
...
crystalline_alloy.localizedName = "晶化合金";
...
crystalline_alloy.addCoreMaterialStats(10,30);
...
duplication.localizedName = "复制金属";
...
energetic_silver.localizedName = "充能银";
...
energetic_silver.addCoreMaterialStats(13,17);
...
melodic_alloy.localizedName = "旋律合金";
...
refinediron.representativeItem = <item:techreborn:ingot:19>;
refinediron.liquid = <liquid:refinediron>;
refinediron.addItem(<ore:ingotRefinedIron>);
refinediron.localizedName = "精炼铁";
...
refinediron.addCoreMaterialStats(12,16);
...
useful_metal.liquid = <liquid:tic_useful_metal>;
useful_metal.addItem(<ore:ingotUseful>);
useful_metal.localizedName = "实用合金";
...
vivid_alloy.localizedName = "生动合金";
...
vivid_alloy.addCoreMaterialStats(30,25);
vivid_alloy.addPlatesMaterialStats(4,20,1);
vivid_alloy.addTrimMaterialStats(20);
vivid_alloy.register();

val gelid_gem = ExtendedMaterialBuilder.create("rrr_gelid_gem");
gelid_gem.color = Color.fromHex("22C0F9").getIntColor();
gelid_gem.craftable = true;
gelid_gem.castable = false;
gelid_gem.representativeItem = <item:redstonerepository:material:5>;
gelid_gem.addItem(<ore:gemGelidCrystal>);
gelid_gem.localizedName = "极寒水晶";
gelid_gem.addHeadMaterialStats(900,12,9,6);
gelid_gem.addHandleMaterialStats(1,90);
gelid_gem.addExtraMaterialStats(135);
